import {
  ...
  import { Link as ScrollLink } from "react-scroll"; // Import renamed ScrollLink
		...
		>
		  <Stack flex={1} spacing={{ base: 5, md: 10 }}>
			...
			>
			  ...
			  <Button
				as="a" // Use <a> tag to open external URL
				href="https://github.com/Gojodept/Get-Apartments/tree/main" // Replace with the URL you want to link to
